...
Source: asterisk-1.8.32.1.tar.gz
Type: ipkg
...
Submenu: Telephony
Version: 1.8.32.1-1
Depends: +libc +USE_EGLIBC:librt +USE_EGLIBC:libpthread asterisk18 @TARGET_lantiq +PACKAGE_asterisk18-chan-lantiq:kmod-ltq-vmmc
Menu-Depends: 
Provides: 
Section: net
Category: Network
...
Description:    Asterisk is a complete PBX in software. It provides all of the features
 ...
 protocols, and can interoperate with almost all standards-based telephony
 equipment using relatively inexpensive hardware.
This package provides support An implementation of Lantiq TAPI channel in Asterisk.
http://www.asterisk.org/
Jiri Slachta <slachta@cesnet.cz>
@@
